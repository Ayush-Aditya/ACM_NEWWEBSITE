  ...
  return (
    <div className="bg-black">
      ...
      <div
        ...
        style={{ backgroundImage: "url('landingback.svg')" }}
      >
        <div className="absolute inset-0 bg-black opacity-45"></div>
        
        <div className="relative z-10 text-center md:text-center text-white max-w-[90%] md:max-w-[50%] mx-auto">
          <h1 className="text-5xl md:text-8xl font-inter whitespace-nowrap ">A C M</h1>
          <h2 className="text-lg md:text-2xl lg:text-3xl font-semibold mt-4 text-purple-400">
